...
var addonProto = {
  ...
  */
  _shouldCompilePodTemplates: function() {
    var fsInfo = this._fileSystemInfo();

    return !fsInfo.addonTemplatesTreeInAddonTree && fsInfo.hasPodTemplates;
  },
  ...
  _fileSystemInfo: function() {
    ...
    this._cachedTemplateInfo = {
      ...
      addonTemplatesTreeInAddonTree: addonTemplatesTreeInAddonTree
    };
  ...
  */
  compileTemplates: function(tree) {
    ...
    if (this.shouldCompileTemplates()) {
      ...
      if (this._fileSystemInfo().addonTemplatesTreeInAddonTree) {
        // no need to process modules here, since we will process
        // them as part of the main addon tree transpilation
        return processedTemplateTree;
      }
